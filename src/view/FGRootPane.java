...
public class FGRootPane extends RootPane {
    ...
    private void createTitlePane() {
        ...
        StackPane imageBtn = createImageButton(
                "resources/title_icon.png", 110, 110,
                () -> newGameButton.fire()
        );
    ...
    private void createGamePane() {
        ...
        quitImg.setFitWidth(28);
        quitImg.setFitHeight(28);
        ...
        restartImg.setFitWidth(28);
        restartImg.setFitHeight(28);
        ...
        center.setPrefSize(Region.USE_COMPUTED_SIZE, Region.USE_COMPUTED_SIZE);
        center.setStyle("-fx-background-color: #1a1a2e;");

        StackPane boardContainer = new StackPane(group);
        boardContainer.setAlignment(Pos.CENTER);

        center.getChildren().add(boardContainer);
